...
//   });
  window.addEventListener('DOMContentLoaded', ()=> {
    ...
    setInterval(createLeaf.bind(this, 'leaf-1', 30, 80), 1000);
    setInterval(createLeaf.bind(this, 'leaf-2', 30, 80), 1000);
    setInterval(createLeaf.bind(this, 'leaf-3', 30, 80), 1000);
    setInterval(createLeaf.bind(this, 'leaf-4', 30, 80), 1000);
    setInterval(createLeaf.bind(this, 'leaf-5', 30, 80), 1000);
  });
